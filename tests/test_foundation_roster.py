...
EXPECTED_ARMS = {
    ...
    "moirai2_small", "toto2_22m", "sundial_base", "tabpfn_ts",
}
...
def test_roster_is_registry_backed_and_separates_native_from_training_admission():
    ...
    assert get_arm("tabpfn_ts").overall_status == "blocked"
    ...
    assert get_arm("tabpfn_ts").ohlcv_mode == "decomposed_univariate_or_tabular_support_set"
